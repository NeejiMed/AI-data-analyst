...
STATUSES =  ["completed", "completed", "completed", "refunded", "pending"] # more weight on completed orders for realism
...
CUSTOMER_NAMES = [
    "Acme Corp", "TechNova", "DataFlow Inc", "Bright Analytics",
    "Summit Systems", "Apex Digital", "CoreTech", "NexGen Solutions",
    "Vertex AI Labs", "Pinnacle Data", "Quantum Systems", "Horizon Tech",
    "Atlas Computing", "Meridian Software", "Zenith Analytics",
    "Catalyst Corp", "Momentum Tech", "Elevate Systems", "Fusion Data",
    "Clarity Analytics", "Synergy Corp", "Pioneer Tech", "Vanguard AI",
    "Eclipse Systems", "Nova Analytics", "Stellar Data", "Orbit Tech",
    "Cosmo Computing", "Nebula Systems", "Pulsar Analytics",
]
...
def seed_orders(db: Session, customers: list[Customer], products: list[Product]) -> None:
    """
    ...
    for day_offset in range(0, 540): # 18 months
        ...
        for _ in range(daily_orders):
            ...
            for product in selected_products:
                ...
                discount_pct = random.choice([0, 0.05, 0.1, 0.15]) # 0%, 5%, 10%, 15% discount
...
def main():
    ...
    try:
        ...
        print("  Run the app and start quering your data analyst with natural language questions! 🚀")
